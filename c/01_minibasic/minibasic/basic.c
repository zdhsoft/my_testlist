...
static DIMVAR* dimvariables = NULL;
static int ndimvariables = 0;
...
static const char* string = NULL;        /* string we are parsing */
...
int main(int argc, const char* argv[]) {
	return basic("", stdin, stdout, stderr);
}
