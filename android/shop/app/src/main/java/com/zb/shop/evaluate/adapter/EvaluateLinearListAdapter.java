...
public class EvaluateLinearListAdapter extends ViewGroupLayoutBaseAdapter<EvaluateBean2> {
    ...
    private OnItemClickListener<String> mStringOnItemClickListener;
    ...
    public void setStringOnItemClickListener(OnItemClickListener<String> stringOnItemClickListener) {
